...
export default function Footer() {
  ...
  return (
    <footer className="mt-14 pb-5 w-full capitalize flex flex-col items-center justify-center border-t-2 border-gray-dim">
      <section className="p-3 my-14 m-w-[300px] w-[99%] max-w-[1300px] grid md:grid-cols-2 lg:grid-cols-3 xl:flex xl:justify-between xl:items-start gap-3">
        ...
        <div className="lowercase my-5">
          ...
          <Form className="my-4 flex p-4 md:p-0 md:flex-row flex-col">
            <input
              type="email"
