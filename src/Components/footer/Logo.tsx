...
const Logo = () => (
    <div className="flex flex-col items-center w-full sm2:col-span-3 max-w-[350px] min-h-[130px] text-blue-400 font-extrabold mb-2 sm2:mb-4 self-center xl:self-start border sm:border-none transition-all duration-300">
