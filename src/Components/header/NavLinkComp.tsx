        ...
        <>
            ...
            <div className="nav-link-div">
                <button
                    ...
                    className='nav-link-div-btn'
                >
                    <h3 className='cursor-pointer capitalize'>house plans</h3>
                    <span className={`${isPlansPressed ? '' : 'rotate-180 hover:rotate-180'} hover:rotate-180 transition-all duration-300`}><BsChevronUp /></span>
                </button>

                <div className={`${isPlansPressed ? 'h-full' : 'h-0'} transition-custom`}>
                    <div className={`${isPlansPressed ? 'translate-y-0' : 'translate-y-[-105%] md:translate-y-0'} navLink-style`}>
                        <NavDropDown />
                    </div>
                </div>
            </div>
            ...
            <div className="nav-link-div">
                <NavLink style={({ isActive }) => isActive ? activeStyle : undefined} to={'contact'}>contact us</NavLink>
            </div>
            <div className="nav-link-div">
