    ...
    <>
      ...
      <div className="nav-link-div">
        <button 
            ...
            className="nav-link-div-btn group"
        >
          <h3 className="cursor-pointer capitalize">house plans</h3>
          <span
            className={`${
              isPlansPressed ? "" : "rotate-180 hover:rotate-180"
        ...
        <div
          className={`${isPlansPressed ? "h-full" : "h-0"} transition-custom`}
        >
          <div
            className={`${
              isPlansPressed
            ...
            } navLink-style md:hidden group-hover:md:flex`}
          >
            <NavDropDown />
          </div>
        </div>
